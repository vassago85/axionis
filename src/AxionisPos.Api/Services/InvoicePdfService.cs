...
public class InvoicePdfService
{
    ...
    private const string DefaultAccentHex = "#06B6D4";
            ...
            container.Page(page =>
            {
                ...
                page.Content().PaddingTop(14).Column(col =>
                {
                    ...
                    col.Item().PaddingTop(8).Row(totalRow =>
                    {
                        ...
                        totalRow.ConstantItem(240).Background("#ECFEFF")
                            .Border(1).BorderColor("#A5F3FC")
        ...
        return Document.Create(container =>
        {
            container.Page(page =>
            {
                ...
                page.Content().PaddingTop(14).Column(col =>
                {
                    ...
                    col.Item().PaddingTop(14).Background("#ECFEFF")
                        .Border(1).BorderColor("#A5F3FC").Padding(10)
