namespace AxionisPos.Api.Domain;
...
public class BusinessSettings
{
    ...
    /// <summary>Storage filename under {AXIONIS_DATA_DIR}/branding/ (e.g. "logo.png"). Null = use bundled default.</summary>
    ...
    /// deployments keep behaving exactly as before until explicitly enabled.
    /// </summary>
