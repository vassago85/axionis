...
const LEGACY_STORAGE_KEY = 'ax-pos-pwa-install-dismissed'
...
.pwa-banner {
  ...
  padding-bottom: max(var(--ax-space-3), env(safe-area-inset-bottom));
  background: linear-gradient(180deg, rgba(10, 10, 11, 0.92) 0%, #020617 100%);
