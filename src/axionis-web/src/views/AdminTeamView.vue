...
<template>
  <div class="team-page">
    ...
    <McCard title="Invite user">
      <p class="team-lead ax-text-muted">
    ...
    <McCard title="Users" :padded="false">
      <div class="team-table-scroll">
        <table class="ax-table team-table">
          <thead>
            <tr>
              <th>Email</th>
              <th>Name</th>
    ...
    <McModal v-model="showEditModal" title="Edit user">
      <p class="team-modal-hint ax-text-muted" style="margin-bottom: 0.75rem">
      ...
      <p v-if="editRoleList.length === 0" class="team-modal-hint ax-text-warn">
    ...
    <McModal v-model="showResetModal" title="Set password">
      ...
      <p class="team-modal-hint ax-text-muted">Min. 10 characters with upper, lower, digit, and symbol.</p>
      <template #footer>
    ...
    <McModal v-model="showDeleteModal" title="Delete user">
      ...
      <p class="team-modal-hint ax-text-muted">
