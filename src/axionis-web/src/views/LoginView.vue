  ...
  <div class="auth-layout">
    <div class="auth-panel">
      <div class="auth-panel__brand">
        <img class="auth-panel__logo" :src="logoUrl ?? logoLightBg" :alt="businessName" />
...
.auth-layout {
  ...
  padding: 1.5rem;
  background:
    radial-gradient(ellipse 100% 80% at 50% -30%, rgba(6, 182, 212, 0.22), transparent),
    linear-gradient(165deg, #0f172a 0%, #020617 45%, #1e293b 100%);
}
