...
<style scoped>
.qp { min-height: 100dvh; padding: 1.25rem; background: #f1f5f9; }
.qp__sheet {
  max-width: 640px;
  margin: 0 auto;
  background: #fff;
...
.qp__num { margin: 0.25rem 0 0; font-size: 0.95rem; font-weight: 600; color: #475569; }
.qp__err {
...
.qp__meta dt { margin: 0; font-size: 0.7rem; font-weight: 700; letter-spacing: 0.08em; text-transform: uppercase; color: #475569; }
.qp__meta dd { margin: 0.2rem 0 0; font-size: 0.95rem; color: #0f172a; }
...
.qp-sub { font-size: 0.8rem; color: #475569; margin-top: 0.15rem; }
.qp__total {
  display: flex;
...
.qp__total strong { font-size: 1.35rem; color: #0f172a; }
.qp__notes {
  margin-top: 1.25rem;
  padding: 1rem 1.1rem;
  background: #fafaf8;
...
.qp__notes p { margin: 0; white-space: pre-line; color: #1e293b; }
.qp__pdf {
  display: inline-flex;
  align-items: center;
...
.qp__pdf:hover { background: #06b6d4; color: #020617 !important; }
.qp__contact {
  margin-top: 2rem;
  padding-top: 1.25rem;
...
.qp__contact-name { margin: 0 0 0.5rem; font-size: 1rem; font-weight: 700; color: #0f172a; }
.qp__address { white-space: pre-line; }
.qp__contact a { color: #0891b2; }
