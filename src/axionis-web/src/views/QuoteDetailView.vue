...
.q-line-sub { font-size: 0.8rem; color: var(--ax-app-text-muted, #475569); }
...
.q-kv dt { margin: 0; color: var(--ax-app-text-muted, #475569); }
.q-kv dd { margin: 0; }
...
.q-totals dt { margin: 0; color: var(--ax-app-text-muted, #475569); }
...
.q-share-hint { margin: 0 0 0.75rem; font-size: 0.85rem; color: var(--ax-app-text-muted, #475569); }
.q-convert-info { margin: 0 0 0.75rem; font-size: 0.9rem; color: var(--ax-app-text-muted, #475569); }
</style>
