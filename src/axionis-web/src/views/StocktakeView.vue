  ...
  <div class="st-page">
    ...
    <template v-else>
      ...
      <McCard v-else title="Complete">
        <p class="ax-text-muted" style="margin: 0">This session is closed. Start a new session for the next count.</p>
      </McCard>
    </template>
...
.st-step {
  ...
  border: 1.5px solid var(--ax-app-border-soft, #cbd5e1);
...
.st-step__line {
  width: 2rem;
  height: 3px;
  background: var(--ax-app-border-subtle, #94a3b8);
  border-radius: 2px;
}
...
.st-session-bar {
  ...
  border-radius: 14px;
  box-shadow: var(--ax-app-shadow-sm, 0 1px 3px rgba(0,0,0,0.1));
}
