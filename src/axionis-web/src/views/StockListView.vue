...
<template>
  <div class="stock-page">
    <McPageHeader title="Stock list" description="Full inventory. Use Import to load items from your supplier workbook or CSV.">
...
.stock-barcode-scan {
  ...
  gap: 0.4rem;
  padding: 0 0.85rem;
  border: 1.5px solid var(--ax-accent, #06b6d4);
  background: var(--mc-app-surface, #fff);
